...
public class Java8StatisticServiceTests {
    private final Java8StatisticService staticService = new Java8StatisticService();
    ...
    private static Stream<Arguments> groupStringsByLastLetterParameters() {
        return Stream.of(
                Arguments.of(Set.of(List.of("asfsd", "", "dfsdf"), List.of("asfsda", "sffd")),
                        Map.of('A', List.of("asfsda"),
                                'D', List.of("asfsd", "sffd"),
                                'F', List.of("dfsdf")))
        );
    }
